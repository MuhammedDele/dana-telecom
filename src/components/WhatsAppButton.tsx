...
export default function WhatsAppButton() {
  const msg = encodeURIComponent(
    "مرحبًا دانا تيليكوم، أرغب بالاستفسار عن خدماتكم.",
  );
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 font-bold text-white shadow-lg transition-transform hover:-translate-y-1"
    >
